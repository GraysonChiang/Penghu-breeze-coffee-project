 ...
 <div class="item"><a href="img/works/1.jpg" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg"><img src="img/works/1.jpg" class="img-responsive" alt="img"></a></div>
    ...
    <section id="partner" class="home-section color-dark bg-white">
        ...
        <div class="row">
	            ...
	            <div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow fadeInLeft" data-wow-delay="0.2s">
						<div class="service-icon">
							<p> <a href="{{url('http://www.audi.com.tw/tw/brand/zh.html')}}"><img src="img/parner/audi.png" width="150" height="150" alt="" /></a></p>
						</div>
					</div>
	            </div>
                <div class="col-xs-6 col-sm-3 col-md-3">
				<div class="wow fadeInLeft" data-wow-delay="0.2s">
					<div class="service-icon">
						<p> <a href="{{url('http://energydrink-tw.redbull.com/')}}"><img src="img/parner/redbull.png" width="150" height="150" alt="" /></a></p>
					</div>
				</div>
           		</div>
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow fadeInLeft" data-wow-delay="0.2s">
						<div class="service-icon">
							<p> <a href="{{url('http://www.lamborghini.com/en/home/')}}"><img src="img/parner/lamber.png" width="150" height="150" alt="" /></a></p>
						</div>					
					</div>
		        </div>			
				<div class="col-xs-6 col-sm-3 col-md-3">
					<div class="wow fadeInLeft" data-wow-delay="0.2s">
						<div class="service-icon">
						<p> <a href="{{url('https://www.facebook.com/petitefarm.penghu/?fref=ts')}}"><img src="img/parner/farm.jpg" width="150" height="150" alt="" /></a></p>
						</div>
					</div>
	            </div>
        </div>
